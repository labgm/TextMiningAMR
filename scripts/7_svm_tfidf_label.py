...
#2. Dataset train
with open('results/4_dataset_tfidf_label.csv') as csv_file_:       
...
joblib.dump(clf, 'results/model_svm_2.pkl') # clf = model trained
...
plt.savefig('results/confusion_matrix_svm_2.png');

accuracy = metrics.accuracy_score(y_test_mean, result)

file_report = open('results/Results_svm_2.txt', 'w')
